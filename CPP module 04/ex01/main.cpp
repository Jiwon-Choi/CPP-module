...
int main(void) {
...

    {
        ...
        std::cout << "    Copy Cat's idea : " << cat.getBrainIdea(1) << std::endl;
        std::cout << "Original Cat's idea : " << static_cast<Cat*>(animal[0])->getBrainIdea(1) << std::endl;
    }
